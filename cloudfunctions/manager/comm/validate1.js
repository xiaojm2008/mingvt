...
var validate = (format, value, fieldid, fromObj) => {
  var err = null,
  ...
  if (v_type != 'object') {
    ...
    /*
    if (format.dict) {
      var dictlist = format.dictlist && format.dictlist.length > 0 ? format.dictlist : dict[format.dict];
      if(!dictlist.some((v,i,a)=>{
        return v.code == value
      })){
        return {
