...
const default_shopid = 'SHP1581604412240e4762b43bdb2f538';
...
var getRightDesc = (type, actionname) => {
  var child = actionList.find(v => v.id == type);
  if (child && child.children && child.children.length > 0) {
    child = child.children.find(v => v.id == actionname);
    return child ? child.name : actionname;
  }
  return actionname;
}
module.exports = {
